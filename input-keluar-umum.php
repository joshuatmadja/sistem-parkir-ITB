...
<div class="full">
	<div class="container pd-t60">
		<div class="row center">
			...
			<div class="col-md-12 subtitle mg-t10 mg-b60">Kendaraan Keluar Umum</div>
		</div>
		<div id="message"></div>
		<form id="form-input" method="get" action="proses-keluar-umum.php">
			<div class="row">
...
<script>
	...
	$('#barcode').on('keyup',function (){
		...
		$.ajax({url:"find-umum-out.php?id="+$(this).val(), success: function(result){
